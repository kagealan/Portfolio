    ...
    return (
        <IonPage>
            <IonContent fullscreen>
                <main className='h-full w-full font-[Poppins] overflow-hidden bg-gray-900 flex justify-center items-start p-5' style={{backgroundImage:'url(./Image/bg5.png)',backgroundSize:'cover'}}>
